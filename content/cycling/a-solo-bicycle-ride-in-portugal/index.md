...
{{< figure src="cover-route-map.png" alt="The route I followed" class="right" >}}
...
{{< figure src="lisbon.jpg" alt="Lisbon Alfama district" class="left" >}}
...
{{< figure src="guarda.jpg" alt="The Se in Guarda" class="left" >}}
...
{{< figure src="mirandale.jpg" alt="On my way to Mirandale" class="left" >}}
...
{{< figure src="leaving-mirandale.jpg" alt="Cold, cloudy and moist" class="left" >}}
...
{{< figure src="vila-pouca-de-aguiar.jpg" alt="Keep on climbing towards Vila Pouca de Aguiar" class="left" >}}
...
{{< figure src="view.jpg" alt="Rota Romanico" class="left" >}}
...
{{< figure src="bridge.jpg" alt="Ponte Luis I" class="left" >}}
...
{{< figure src="porto.jpg" alt="Beautiful Porto seen from the monastery across the river" class="left" >}}
...
{{< figure src="tiles.jpg" alt="Some of the many tile designs in Portugal" class="left" >}}
...
{{< figure src="aveiro.jpg" alt="Aveiro town" class="left" >}}
...
{{< figure src="lunch.jpg" alt="Figueira da Foz " class="left" >}}Figueira da Foz
...
{{< figure src="atlantic-cycle-route.jpg" alt="The atlantic cycle route " class="left" >}}
...
{{< figure src="obidos.jpg" alt="Obidos" class="left" >}}
...
{{< figure src="cycle-shop.jpg" alt="The bike rental shop" class="left" >}}
...
{{< figure src="arsenal.jpg" alt=" Rua do Arsenal" class="left" >}}
...
{{< figure src="sintra.jpg" alt="The Moorish ruins at Sintra" class="left" >}}
