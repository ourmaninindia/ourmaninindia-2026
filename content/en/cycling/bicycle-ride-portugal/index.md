...
{{< figure src="cover-route-map.png" caption="The route I end up doing" alt="The route I followed" class="right" >}}
...
{{< figure src="lisbon.jpg" alt="Lisbon Alfama district" caption="Lisbon Alfama district" class="small left" >}}
...
{{< figure src="mirandale.jpg" alt="On my way to Mirandale" caption="On my way to Mirandale" class="small left" >}}
...
{{< figure src="leaving-mirandale.jpg" alt="Cold, cloudy and moist" caption="Cold, cloudy and moist" class="small right" >}}
...
{{< figure src="view.jpg" alt="Rota Romanico" caption="Rota Romanico"  class="small right" >}}
...
{{< figure src="bridge.jpg" alt="Ponte Luis I" caption="Ponte Luis I" class="small left" >}}
...
{{< figure src="porto.jpg" caption="Beautiful Porto seen from the monastery across the river" alt="Beautiful Porto seen from the monastery across the river" class="small left" >}}
...
{{< figure src="tiles.jpg" alt="Some of the many tile designs in Portugal" caption="Some of the many tile designs in Portugal" class="left" >}}
...
{{< figure src="aveiro.jpg" alt="Aveiro town" caption="Aveiro town"  class="small right" >}}
...
{{< figure src="lunch.jpg" alt="Figueira da Foz" caption="Lunch at Figueira da Foz " class="small left" >}}
...
{{< figure src="atlantic-cycle-route.jpg" alt="The atlantic cycle route " caption="The atlantic cycle route " class="small left" >}}
...
{{< figure src="obidos.jpg"  alt="Obidos" caption="Beautiful Obidos town" class="small right" >}}
...
{{< figure src="cycle-shop.jpg" alt="The bike rental shop" caption="The bike rental shop" class="small left" >}}
...
{{< figure src="arsenal.jpg" alt="Rua do Arsenal" caption="Rua do Arsenal" class="small left" >}}
...
{{< figure src="sintra.jpg" alt="The Moorish ruins at Sintra" caption="The Moorish ruins at Sintra" class="left" >}}
